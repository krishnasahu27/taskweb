...
<nav class="top-nav">
    <div class="nav-wrapper">
        <div class="nav-left">
            ...
            <a href="register_employee.php" class="<?php echo $current_page === 'register_employee.php' ? 'active' : ''; ?>">Register Employee</a>
            ...
            <a href="delete_employee.php" class="<?php echo $current_page === 'delete_employee.php' ? 'active' : ''; ?>">Delete Employee</a>
        </div>
        <div class="nav-right">
